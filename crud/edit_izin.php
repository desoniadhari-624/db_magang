...
include "../config.php";
$id = $_GET['id'];
$data = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM izin WHERE id='$id'"));
...
if(isset($_POST['update'])){
    ...
    $alasan = $_POST['alasan'];
    mysqli_query($conn, "UPDATE izin SET magang_id='$magang_id', tanggal='$tanggal', alasan='$alasan' WHERE id='$id'");
